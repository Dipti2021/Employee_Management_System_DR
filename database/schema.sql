...
CREATE TABLE employee(
 ...
 FOREIGN KEY (role_id) REFERENCES emprole(id),-- holds the foreign key for the role id
 FOREIGN KEY (manager_id) REFERENCES employee(id),-- holds the foreign key for the manager id
 PRIMARY KEY (id)
);
